 ...
 *  MIT License 2024 Rasya R.
 *  Tysm for XyzTeams n Adrian.
*/

import { areJidsSameUser, downloadContentFromMessage, downloadMediaMessage, extractMessageContent, generateWAMessage, generateWAMessageContent, jidDecode, jidNormalizedUser, prepareWAMessageMedia } from "@whiskeysockets/baileys";
    ...
    const Client = Object.defineProperties(client, {
                    ...
                    viewOnceMessage: {
                        message: {
                            ...
                            interactiveMessage: proto.Message.InteractiveMessage.create({
                                ...
                                footer: proto.Message.InteractiveMessage.Footer.create({ text: footer || "(c) 2024 PycoBot" }),
                    ...
                    viewOnceMessage: {
                        message: {
                            ...
                            interactiveMessage: proto.Message.InteractiveMessage.fromObject({
                                footer: proto.Message.InteractiveMessage.Footer.create({ text: "(c) 2024 PycoBot" }),
        ...
        downloadMediaMessage: {
            async value(message, filename) {
                let media = await downloadMediaMessage(
                    ...
                    {},
                    {
                        logger: pino({ timestamp: () => `,"time":"${new Date().toJSON()}"`, level: "fatal" }).child({ class: "chocopys" }),
        ...
        downloadAndSaveMediaMessage: {
            async value(message, attachExtension = true) {
                ...
                const filename = "./dist/temp/" + randomBytes(6).readUIntLE(0, 6).toString(36)
    ...
    try {
        ...
        m.reply = async (text, options = {}) => {
            if (typeof text === "string") {
                return await client.sendMessage(m.from, { text, ...options, contextInfo: { forwardedNewsletterMessageInfo: { newsletterName: "(c) 2024 PycoBot", newsletterJid: "120363182916458068@newsletter" } } }, { quoted: m, ephemeralExpiration: m.expiration, ...options });
